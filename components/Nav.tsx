			...
			>
				...
				<div className="hidden -mt-1 lg:flex flex-col">
					<div className="flex flex-row lg:gap-2">
						...
						{(process.env.NO_I18N !== "1") && <Link className="px-2 py-1 rounded-lg bg-black bg-opacity-20 hover:bg-opacity-25 text-white" href={router.asPath} locale={locale === "en" ? "es" : "en"}>
							{locale === "en" ? "es" : "en"}
						</Link>}
					</div>
				</div>
