    ...
    return (
        <div className="pb-10 px-5 md:px-12 lg:px-24">
            ...
            <p className="dark:text-white text-center">
                <a
                    href="https://docs.google.com/document/d/153JGlCQa2wnOLVIRs0Irh8VeXQMQa8fj9Mj7Kr1UU6U/edit?tab=t.0"
                    className="text-red-500 hover:underline underline-offset-2"
                >
                    Click here for a full list of administrator
                    responsibilities.
                </a>
            </p>
            <div className="flex gap-5 flex-wrap justify-center">
                {admin.attributes.admin.data.map((s, i) => (
                    ...
                    >
                        <img
                            src={
                                s.attributes.image.data == null ||
                                s.attributes.nopicture
                                    ? "/assets/soon.jpg"
