...
export default function Calendar({ events }: CalendarProps) {
	return (
		<div className="rounded-lg md:px-40 pb-10 dark:text-white">
			...
			<p className="text-center">A more detailed PDF of the school year schedule is <a className="text-red-500 hover:underline underline-offset-2" href="https://prod.montgomeryschoolsmd.org/siteassets/district/info/calendars/2024/calendar-2024-attachmentb.pdf">available here</a>.</p>
			<br/>
