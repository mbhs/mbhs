...
export default function Calendar({ events, dates }: CalendarProps) {
	...
	return (
		<div className="rounded-lg md:px-40 pb-10 dark:text-white">
			...
			<p className="text-center">A more detailed PDF of the school year schedule is <a className="text-red-500 hover:underline underline-offset-2" href="https://minio.mbhs.edu/strapi/May_Testing_Schedule_2026_Google_Docs_7b303550f9.pdf">available here</a>.</p>
			<br/>
